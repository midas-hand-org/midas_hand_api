...
THUMB_TARGETS_RAD = {
    "index": np.array(
        [
            [-1.29007784, 0.15339808, -0.36201946, 0.75625253],
            [-0.889708859, -0.0168737865, 0.0291456404, 1.20264094],
    ...
    "ring": np.array(
        [
            [-0.0720971, -0.90811662, 0.20555343, 1.92207793],
            [-0.3037282, -0.37429131, 0.40803889, 2.02332066],
