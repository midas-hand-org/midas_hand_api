...
These defaults match common X-series Dynamixel motors. Check the e-Manual for
your exact motor model before relying on current units or unsupported registers.
"""
